...
let write = exports.write = (() => {
  var ref = _asyncToGenerator(function* (file, data, passphrase, options = {}) {
    ...
    let fileObj = {
      header: headerBuf,
      checksum: file.computeChecksum(mdBuf, encBlob),
      metadata: mdBuf,
      blob: encBlob
    };
...
const BufOrStr = function () {
  function BufOrStr(input) {
    return input instanceof Buffer || input instanceof String;
  }
